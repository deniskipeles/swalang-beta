#!/usr/bin/env bash
# build-libgit2-android-arm64.sh
# Builds libgit2 (https://github.com/libgit2/libgit2) for Android arm64-v8a
...
# ------------------------------------------------------------------
# 2.  libgit2 submodule / clone
# ------------------------------------------------------------------
LIBRARY_NAME="libgit2"
REPO_DIR=".extensions/$LIBRARY_NAME"
[[ -d "$REPO_DIR" ]] || git clone --depth 1 --branch v1.8.1 \
  https://github.com/libgit2/libgit2.git "$REPO_DIR"
cd "$REPO_DIR"
