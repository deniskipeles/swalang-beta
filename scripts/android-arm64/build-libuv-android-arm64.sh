#!/usr/bin/env bash
# build-libuv-android-arm64.sh
# Builds libuv (https://github.com/libuv/libuv) for Android arm64-v8a
...
# ------------------------------------------------------------------
# 2.  libuv submodule / clone
# ------------------------------------------------------------------
LIBRARY_NAME="libuv"
REPO_DIR=".extensions/$LIBRARY_NAME"
[[ -d "$REPO_DIR" ]] || git clone --depth 1 --branch v1.48.0 \
  https://github.com/libuv/libuv.git "$REPO_DIR"
cd "$REPO_DIR"
