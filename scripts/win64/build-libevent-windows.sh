#!/usr/bin/env bash
# build-libevent-windows.sh  –  cross-compile libevent for Windows x64 (MinGW-w64)
set -euo pipefail
...
echo "🧬 2. Clone official libevent"
LIBRARY_NAME="libevent"
REPO_DIR=".extensions/$LIBRARY_NAME"
[[ -d "$REPO_DIR" ]] || \
    git clone --depth=1 https://github.com/libevent/libevent.git  "$REPO_DIR"
cd "$REPO_DIR"
