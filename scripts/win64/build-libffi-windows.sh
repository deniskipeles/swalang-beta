#!/usr/bin/env bash
# build-libffi-windows.sh  –  cross-compile libffi for Windows x64 (MinGW-w64)
set -euo pipefail
...
echo "🧬 2. Clone official libffi"
LIBRARY_NAME="libffi"
REPO_DIR=".extensions/$LIBRARY_NAME"
[[ -d "$REPO_DIR" ]] || \
    git clone --depth=1 https://github.com/libffi/libffi.git  "$REPO_DIR"
cd "$REPO_DIR"
