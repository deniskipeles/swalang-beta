#!/usr/bin/env bash
# build-mbedtls-windows.sh  –  cross-compile mbed TLS for Windows x64 (MinGW-w64)
set -euo pipefail
...
echo "🧬 2. Clone official mbed TLS (with sub-modules)"
...
cd "$REPO_DIR"
# Ensure submodules are present, especially after a fresh clone
